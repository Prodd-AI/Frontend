...
const SelectRoleCard = ({
	...
	return (
		<section
			className={`md:max-w-52 w-full px-5 py-9 rounded-2xl ${
				active
			...
			<div
				className={`rounded-full size-11  bg-grey-light text-primary flex justify-center items-center text-2xl`}>
				{icon}
			</div>
			<div className="flex flex-col gap-0.5">
				...
				<p className="text-xs font-semibold text-center">{description}</p>
			</div>
			<input
				type="radio"
				name="role"
				className="accent-purple-600 checked:accent-white size-4.5"
				checked={active}
				readOnly
			/>
		</section>
