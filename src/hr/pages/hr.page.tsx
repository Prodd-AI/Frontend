...
// Wrap with the shared layout scaffold
// const WrappedHrPage = withTeamMemberScaffold(HrPage);

// Header Child (Export Button)
const ExportButton = () => (
  <Button className="bg-primary-color hover:bg-primary-color/90 gap-2">
    <FiDownload /> Export Report
  </Button>
);

// const HrPageWithHeader = () => <WrappedHrPage HeaderChild={<ExportButton />} />;
